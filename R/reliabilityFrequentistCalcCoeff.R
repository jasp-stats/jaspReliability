...
.frequentistOmega <- function(jaspResults, dataset, options, model) {
  if (!is.null(.getStateContainer(jaspResults)[["omegaObj"]]$object))
    return(.getStateContainer(jaspResults)[["omegaObj"]]$object)
  ...
  stateContainer[["omegaObj"]] <- createJaspState(out, dependencies = c("omegaScale", "omegaItem", "omegaEst",
                                                                        "omegaInterval"))
  return(out)
}
...
.frequentistLambda2 <- function(jaspResults, dataset, options, model) {
  ...
  if (!is.null(.getStateContainer(jaspResults)[["lambda2Obj"]]$object))
      return(.getStateContainer(jaspResults)[["lambda2Obj"]]$object)
...
.frequentistLambda6 <- function(jaspResults, dataset, options, model) {
  ...
  if (!is.null(.getStateContainer(jaspResults)[["lambda6Obj"]]$object))
    return(.getStateContainer(jaspResults)[["lambda6Obj"]]$object)
...
.frequentistGlb <- function(jaspResults, dataset, options, model) {
  ...
  if (!is.null(.getStateContainer(jaspResults)[["glbObj"]]$object))
    return(.getStateContainer(jaspResults)[["glbObj"]]$object)
...
.frequentistAverageCor <- function(jaspResults, dataset, options, model) {
  ...
  if (!is.null(.getStateContainer(jaspResults)[["avgObj"]]$object))
    return(.getStateContainer(jaspResults)[["avgObj"]]$object)
...
.frequentistMean <- function(jaspResults, dataset, options, model) {
  if (!is.null(.getStateContainer(jaspResults)[["meanObj"]]$object))
    return(.getStateContainer(jaspResults)[["meanObj"]]$object)
...
.frequentistStdDev <- function(jaspResults, dataset, options, model) {
  if (!is.null(.getStateContainer(jaspResults)[["sdObj"]]$object))
    return(.getStateContainer(jaspResults)[["sdObj"]]$object)
...
.frequentistItemRestCor <- function(jaspResults, dataset, options, model) {
  if (!is.null(.getStateContainer(jaspResults)[["itemRestObj"]]$object))
    return(.getStateContainer(jaspResults)[["itemRestObj"]]$object)
...
.frequentistItemMean <- function(jaspResults, dataset, options, model) {
  if (!is.null(.getStateContainer(jaspResults)[["itemMeanObj"]]$object))
    return(.getStateContainer(jaspResults)[["itemMeanObj"]]$object)
...
.frequentistItemSd <- function(jaspResults, dataset, options, model) {
  if (!is.null(.getStateContainer(jaspResults)[["itemSdObj"]]$object))
    return(.getStateContainer(jaspResults)[["itemSdObj"]]$object)
