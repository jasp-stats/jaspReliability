...
test_that("Main (scale) table results match R, SPSS, SAS and MiniTab", {
  ...
  jaspTools::expect_equal_tables(
    "test"=resultTable,
    "ref"=list("McDonald's <unicode>", 0.762830469875068, 0.748803468173598,
               "", 0.776857471576537, "Cronbach's <unicode>", 0.757381263545318,
               0.742939526669925, "", 0.771189756266616, "Guttman's <unicode>2",
               0.744068664329276, 0.728519956963996, "", 0.759203682937775,
               "Guttman's <unicode>6", 0.764552908800386, 0.749596669466725,
               "", 0.778248039401737, "mean", 2.50730677335111, 2.48349947134054,
               "", 2.53111407536169))
})
