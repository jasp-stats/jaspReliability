...
test_that("Bayesian Individual Item Reliability Statistics table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(4.9262740258844e-06, -0.0302604620110933, -0.00730189174965356,
                                      -0.123891197021977, 0.0494291189911074, 0.0322661722934692,
                                      0.0212125066975763, 0.0325973854277802, 0.181706618970563, 0.201506484849513,
                                      -0.18874858754, 1.1202393681253, 1.05841360919316, 0.0908764111289078,
                                      0.071610849828197, 0.0783885886016254, 0.491758754935352, 0.347636993674243,
                                      "contNormal", 9.40024640628503e-07, -0.0157617947104415, -0.00111243856322423,
                                      -0.076329924017113, 0.0250257087054518, 0.0372377719573931,
                                      0.0263018982813707, 0.0385176798582973, 0.223964092197852, 0.18043738105305,
                                      0.05254867287, 1.02381744124251, 1.01183864387684, 0.101904192043364,
                                      0.0684025775131465, 0.0730991379330716, 0.498872058071683, 0.311403152449827,
                                      "contcor1", 3.87289002980385e-08, -0.00463647527725275, 0.00875019171674773,
                                      -0.0175178921680108, -0.0805010870340148, 0.0472986075910507,
                                      0.038667431651618, 0.0486615947429129, 0.230231431033826, 0.0552126591050449,
                                      0.06968807084, 1.00831589303215, 1.0041493380131, 0.109551905583045,
                                      0.0807291934771201, 0.0876232547094318, 0.550962162915788, 0.228317875033916,
                                      "contcor2", 3.06076329374839e-08, -0.0148054356280015, 0.00210662418230391,
                                      -0.0390610892240463, -0.0786484764858476, 0.0315765590294508,
                                      0.0308430722235896, 0.040822809190591, 0.212612743663956, 0.0698072970377176,
                                      3, 2.02020202020202, 1.4213381090374, 0.0878435386563505, 0.0718948260426243,
                                      0.0786323358702756, 0.475484355930506, 0.204256118691893, "facFive",
                                      0.358369568041053, 0.285237073953381, 0.38010239162854, 0.439831569532479,
                                      0.0164539097397541, 0.479869257412775, 0.434004318276763, 0.491435548543508,
                                      0.56863428804806, 0.184196159162177, 15.9882068024571, 579.15817042274,
                                      24.0657052758223, 0.600166559993091, 0.570258196480785, 0.610285976634783,
                                      0.707868614504747, 0.34352987256172, "debMiss30"))
})
...
test_that("Probability that Reliability Coefficient is Larger than 0.10 and Smaller than 0.30 table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.0577777777777778, 0.257579474218955, "Coefficient <unicode>",
                                      ...
                                      0.117470293201849, "Guttman's <unicode>2", 0.413333333333333,
...
test_that("Bayesian Scale Reliability Statistics table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list("Coefficient <unicode>", 261.905719143696, 0.0335378719395442,
                                      ...
                                      "Split-half coefficient", 243.27819359501, 0.192013548721411,
                                      -0.218621640309873, 1.01175773719457, 0.4985718766494, "Average interitem correlation",
